...
export function AestheticWhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden flex-col pr-0.5 leading-tight sm:flex">
        <span className="text-[10px] font-medium uppercase tracking-[0.12em] text-white/80">WhatsApp</span>
