          ...
          <MagrassStagger className="space-y-4">
            {diagnosis360.steps.map((step, index) => (
              <MagrassStaggerChild key={step}>
                <li className="flex list-none gap-4 rounded-2xl border border-white/10 bg-white/5 p-4 transition-all duration-500 hover:border-[#C5A880]/30 hover:bg-white/10 sm:p-5">
