    ...
    <section data-nav-theme="light" className="bg-ale-ivory py-12 sm:py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="font-display text-2xl font-semibold text-ale-charcoal sm:text-3xl lg:text-4xl">{process.title}</h2>
        ...
        <div className="mt-8 grid gap-4 sm:mt-10 sm:grid-cols-2 sm:gap-6 lg:mt-12 lg:grid-cols-3">
          {process.steps.map((step) => (
            ...
            >
              ...
              <h3 className="mt-2 font-display text-base font-semibold text-ale-charcoal sm:mt-3 sm:text-lg">{step.title}</h3>
