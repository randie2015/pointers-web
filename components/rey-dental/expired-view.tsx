...
export function ReyDentalExpiredView() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-rey-base px-6">
      <div className="max-w-md rounded-3xl border border-rey-neutral/40 bg-white p-10 text-center shadow-sm">
